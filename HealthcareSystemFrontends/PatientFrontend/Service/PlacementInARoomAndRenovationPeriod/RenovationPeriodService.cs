...
namespace Service.PlacementInARoomAndRenovationPeriod
{
    public class RenovationPeriodService
    {
        ...
        {
            List <Examination>  examinations = scheduledExaminationRepository.GetExaminationsByRoomAndDates(renovationPeriod.room, renovationPeriod.BeginDate, renovationPeriod.EndDate);
