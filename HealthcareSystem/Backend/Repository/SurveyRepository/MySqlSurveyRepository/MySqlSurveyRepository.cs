...
namespace Backend.Repository
{
    public class MySqlSurveyRepository : ISurveyRepository
    {
        ...
        private SurveyResult getSurveyResultAboutNursing()
        {
            ...
            {
                throw new NotFoundException("Survey result about hospital doesn't exist in database.");
            }
        }
        ...
        private SurveyResult getSurveyResultAboutBehaviorOfMedicalStaff()
        {
            ...
            {
                throw new NotFoundException("Survey result about medical staff doesn't exist in database.");
            }
        }
