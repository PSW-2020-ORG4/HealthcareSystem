...
{
    public class CreatePatientDTO : ICreateObject
    {
        public object createValidObject()
        {
            return new PatientDTO(name: "Ana", surname: "Anic", jmbg: "1206988452102", gender: GenderType.Z,
        ...
        {
            return new PatientDTO(name: "Ana", surname: "Anic", jmbg: null, gender: GenderType.Z,
