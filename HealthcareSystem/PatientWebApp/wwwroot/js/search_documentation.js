...
function addPrescriptionTable(therapy) {
    let divElement = $(
        ...
        + ' from <span class= "badge badge-light"> ' + therapy.startDate.split('T')[0]  + ' </span >'
        + ' to <span class= "badge badge-light"> ' + therapy.endDate.split('T')[0]  + '</span >'
        + '</h4> '
        + '</div>'
...
function addExaminationRow(examination) {
    let divElement = $(
        ...
        + 'Examination on <span class="badge badge-light">' + examination.dateAndTime.split('T')[0] + " " + examination.dateAndTime.split('T')[1] + '</span> '
        + '</h4>'
        + '</div>'
        + '<div class="card-body p-3">'
