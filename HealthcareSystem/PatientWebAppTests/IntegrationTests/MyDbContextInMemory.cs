    ...
    public class MyDbContextInMemory
    {
        ...
        public void SetFreeAppointmentSearchServiceTestIntegration()
        {
            ...
            var patient = new Patient { Jmbg = "1234567891234", Name = "Pera", Surname = "Peric", DateOfBirth = DateTime.Now, Gender = GenderType.M,
                CityZipCode = 21000, HomeAddress = "Zmaj Jovina 10", Phone = "065452102", Email = "pera@gmail.com", Username = "pera",
                Password = "12345678", DateOfRegistration = DateTime.Now, IsBlocked = false, IsActive = true };
            var patientCard = new PatientCard { Id = 1, BloodType = BloodType.A, RhFactor = RhFactorType.NEGATIVE, Alergies = "",
                MedicalHistory = "", HasInsurance = false, Lbo = "", PatientJmbg = "1234567891234" };
            var speciality = new Specialty { Id = 1, Name = "Kardiolog" };
            var doctor = new Doctor { Jmbg = "0909965768767", Name = "Mira", Surname = "Markovic", DateOfBirth = DateTime.Now, Gender = GenderType.F,
                CityZipCode = 21000, HomeAddress = "Zmaj Jovina 10", Phone = "065452102", Email = "mira@gmail.com", Username = "mira",
                Password = "12345678", NumberOfLicence = "", DoctorsOfficeId = 1, DateOfEmployment = DateTime.Now };
            var doctorSpeciality = new DoctorSpecialty { DoctorJmbg = "0909965768767", SpecialtyId = 1 };
            var examination1 = new Examination { Id = 1, Type = TypeOfExamination.GENERAL, 
                DateAndTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.AddDays(1).Day, 7, 0, 0),
                Anamnesis = "Bol u grlu", DoctorJmbg = "0909965768767", IdRoom = 1, IdPatientCard = 1, ExaminationStatus = ExaminationStatus.CREATED, IsSurveyCompleted = false};
