...
namespace PatientWebAppTests.CreateObjectsForTests
{
    public class CreateTherapy : ICreateTestObject<Therapy>
    {
        ...
        {
            return new Therapy(drug : new Drug(drugType:null, name: "Paracetamol", id:1, quantity:20, expirationDate: new DateTime(2022, 11, 11), producer: "Hemofarm"), examination : new Examination(id: 1, typeOfExamination: TypeOfExamination.GENERAL, dateAndTime: new DateTime(2020, 11, 11), anamnesis: "Bol u grlu", doctor: new Doctor(jmbg: "0909965768767", name: "Ana", surname: "Markovic", dateOfBirth: DateTime.Now, gender: GenderType.F, city: new City(zipCode: 21000, name: "Novi Sad", country: new Country(id: 1, name: "Serbia")),
