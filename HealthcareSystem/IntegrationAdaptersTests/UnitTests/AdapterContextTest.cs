...
namespace IntegrationAdaptersTests.UnitTests
{
    public class AdapterContextTest
    {
        ...
        public void PharmacySystemAdapter_SetPharmacy1Adapter_UnimplementedAdapter()
        {
            ...
            PharmacySystem pharmacy = new PharmacySystem { Id = 2, Name = "apoteka-2", ApiKey = "api-2", Url = "url-2", ActionsBenefitsExchangeName = "exchange-2", ActionsBenefitsSubscribed = true, GrpcAdress = new GrpcAdress("localhost", 30051) };
        ...
        //    var mockFactory = new Mock<IHttpClientFactory>();
        //    AdapterContext adapterContext = new AdapterContext(mockFactory.Object);
        //    PharmacySystem pharmacy = new PharmacySystem { Id = 1, Name = "apoteka-1", ApiKey = "api-1", Url = "url-1", ActionsBenefitsExchangeName = "exchange-1", ActionsBenefitsSubscribed = true, GrpcAdress = new GrpcAdress("localhost", 30051) };
