...
namespace IntegrationAdaptersService4.Repository.Implementation
{
    public class MySqlTenderRepository : IntegrationAdaptersService4.Repository.ITenderRepository
    {
